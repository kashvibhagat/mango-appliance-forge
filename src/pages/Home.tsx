            ...
            <div className="space-y-8 animate-slide-up">
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-lg">
                  {companyInfo.experience} of experience with {companyInfo.factories} factories in {companyInfo.location}. 
              ...
              {/* Company Stats */}
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-6 pt-8">
                <div className="text-center">
                  <div className="text-2xl font-bold text-accent">40+</div>
                  <div className="text-sm text-muted-foreground">Air Cooler Models</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-accent">{companyInfo.experience}</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                With {companyInfo.factories} factories in {companyInfo.location}, we've built a reputation for quality and innovation.
              </p>
              <p className="text-muted-foreground">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-semibold">{companyInfo.factories} Factories</div>

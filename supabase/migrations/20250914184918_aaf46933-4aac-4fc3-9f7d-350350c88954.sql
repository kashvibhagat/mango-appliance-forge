-- Check current triggers and fix only what's needed

-- Set REPLICA IDENTITY FULL for reliable real-time updates (if not already set)
...
DECLARE
  ...
  request_id uuid;
BEGIN
  -- Initialize customer_profile to avoid "not assigned" errors

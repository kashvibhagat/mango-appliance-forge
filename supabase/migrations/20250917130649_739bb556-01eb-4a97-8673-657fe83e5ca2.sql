-- Fix the email notification function to use the correct service role key
  ...
  BEGIN
    SELECT net.http_post(
      ...
      headers := jsonb_build_object(
        ...
        'Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNjZ3ZsZGF6cWx5dnB0c2NoamtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzE3NTk1NywiZXhwIjoyMDcyNzUxOTU3fQ.nI5OQPPcv1u99YstNaKIDV6RJoxB2h-04WnNHZiDSb4'
      ),
    ...
    RAISE NOTICE 'Order email notification sent successfully. Request ID: %', request_id;
